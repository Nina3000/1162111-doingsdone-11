                                ...
                                <li class="main-navigation__list-item">
                                    ...
                                    <span class="main-navigation__list-item-count">
                                        ...
                                        <?php foreach ($tasks as $task): ?>
                                            <?php if ($task['Категория'] == $category):
                                                $amount++;?>
                ...
                <main class="content__main">
                    ...
                    <table class="tasks">
                        <?php foreach ($tasks as $key => $item): ?>
                            <?php if ($item['Выполнен'] == false and $show_complete_tasks == 1): ?>
                                <tr class="tasks__item task" <?php if ($item['Выполнен']): ?>class="task--completed"<?php endif; ?>>
                                    <td class="task__select">
                                        <label class="checkbox task__checkbox">
                                            <input class="checkbox__input visually-hidden task__checkbox" type="checkbox" value="1">
                                            <span class="checkbox__text"><?php echo $item['Задача']; ?></span>
                                        </label>
                                    </td>
